    ...
    class Program
    {
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                ...
                for (int cur = 0; cur < nums.Length; cur++)
                {
                    ...
                    if (nums[cur] != 0)
                    {
                        // Swap only if cur is greater than lastNonZeroFoundAt to avoid unnecessary swaps
        ...
        */
        ...
        static string ConvertIListToNestedList(IList<IList<int>> input)
        {
            ...
            sb.Append("["); 
            // And Add the opening square bracket for the outer list
            ...
            sb.Append("]"); 
            //Here Add the closing square bracket for the outer list
        ...
        static string ConvertIListToArray(IList<int> input)
        {
            ...
            // Join the strings in strArray with cammas and enclose them in square brackets
